...
public class PostApiTest extends TestBase {
	...
	public void postAPiTest() throws JsonGenerationException, JsonMappingException, IOException, JSONException
	{
	 ...
	 Users users=new Users("morpheus","leader"); //expected users details
	...
	// Object to JSON in String
	 ...
	 closablehhtpResponse = client.getPost(postMethodurl, userJsonString, headerMap);
	
	 //1.status code
	 
	 int statusCode=closablehhtpResponse.getStatusLine().getStatusCode();	 
	 Assert.assertEquals(RESPONSE_STATUS_CODE_201, statusCode);
	...
	System.out.println(usersObject.getCreatedAt()); 
	System.out.println(usersObject.getId());
